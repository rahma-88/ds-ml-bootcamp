...
# - Plus joblib save for the API (deployment only)
# ===============================
...
# --------------------------------
# 8) SAVE MODELS (for API) — only extra step vs Lesson 5
# --------------------------------
...
print("Logistic Regression:", label_str(int(log_reg.predict(x_new_df)[0])))
print("Random Forest      :", label_str(int(rf.predict(x_new_df)[0])))
